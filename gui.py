...
class InferenceWorker(QThread):
    ...
    # Size limit for sending frames to API (reduce bandwidth, increase speed)
                ...
                async with websockets.connect(self.ws_url) as ws:
                    ...
                    while self.running:
                        if self.frame_queue:
                            ...
                            # Resize frame before sending to reduce bandwidth and increase speed, especially for high-res RTSP streams. 
                            # API will scale bbox back so it doesn't affect results.
                            ...
                            # Encode JPEG in BGR format (API expects BGR bytes) with quality 70 to reduce size. 
                            # API will decode and convert back to RGB internally.
                            ...
                            if "error" in data:
                                ...
                                # Scale bbox back to original frame size if we resized before sending to API. 
                                # This way we can draw results natively on the original frame without worrying about coordinate mismatch.
                                if scale != 1.0:
                                    inv = 1.0 / scale
